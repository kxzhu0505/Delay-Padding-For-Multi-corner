...
report_checks -path_delay max -group_count 10000   -path_group clk -sort_by_slack > /home/wllpro/llwang07/kxzhu/DelayPadding/tv80_dir/path_max.rpt

# 生成hold time(min delay)报告
# set_operating_conditions min
report_checks -path_delay min -group_count 10000  -path_group clk -sort_by_slack > /home/wllpro/llwang07/kxzhu/DelayPadding/tv80_dir/path_min.rpt
